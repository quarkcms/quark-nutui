...
const createIndexConfig = (enName, package) => {
  ...
  navigationBarTitleText: '${name}',
      ...
      const dirPath = path.join(
        __dirname,
        `../../src/sites/mobile-taro-rn/src/${enName}/pages/${nameLc}`
      )
      ...
      let demoPath = `src/packages/${nameLc}/demo.taro.rn.tsx`
      fse.readFile(demoPath, (err, data) => {
        if (!err) {
          ...
          //   if (fileStrArr[i].indexOf('@/packages/nutui.react.taro.rn') != -1) {
