...
vfs
  .src(['./dist/esm/types/src/packages/nutui.react.taro.rn.d.ts'])
  .pipe(
    map((file, cb) => {
  ...
  .on('end', () => {
    vfs
      .src([
        './dist/esm/types/src/packages/**/*.taro.rn.d.ts',
        '!./dist/esm/types/src/packages/*.taro.rn.d.ts',
      ])
      .pipe(
        map((file, cb) => {
